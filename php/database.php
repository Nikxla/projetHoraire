...
class Database {
    ...
    public static function getInstance() {
        if(!self::$objInstance){
            try{
                $dsn = EDB_HYPEFAM_DBTYPE.':host='.EDB_HYPEFAM_HOST.';port='.EDB_HYPEFAM_PORT.';dbname='.EDB_HYPEFAM_DBNAME;
                self::$objInstance = new PDO($dsn, EDB_HYPEFAM_USER, EDB_HYPEFAM_PASS, array('charset'=>'utf8'));
